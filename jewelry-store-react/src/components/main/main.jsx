...
const Main = () => {
  ...
  useEffect(() => {
    axios
      .get(
        "http://localhost/jewelry-store/jewelry-store-php/products_slideshow.php"
      )
      .then((response) => {
  ...
  return (
    <main>
      <div className="slideshow-container">
        ...
        <br />
        <br />
        <h1 id="latest-products-text" style={{ fontStyle: "italic" }}>
          Latest Products
        </h1>
      ...
      <div className="about-us-container">
        ...
        <div className="about-us-text">
          ...
          <p style={{ textAlign: "justify", fontStyle: "italic" }}>
            ...
            accessory, it is an expression of style and feeling. Whether you are
